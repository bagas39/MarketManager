...
@section('title', 'Stok Opname - Swalayan Segar')
...
@section('content')
    ...
    <header class="mb-6">
        <h1 class="text-3xl font-bold text-gray-800">
            Stok Opname / Perhitungan Fisik Stok
        </h1>
    </header>

    <div class="bg-white rounded-lg shadow-md p-4 sm:p-6 lg:p-4">
        <p class="mb-6 text-gray-600">
            Lakukan perhitungan fisik jumlah barang di rak, lalu masukkan hasilnya
            di kolom <strong>'Stok Fisik'</strong> untuk mencocokkan dengan data sistem.
        </p>
        ...
        <x-table-wrapper>
            <thead class="bg-gray-50">
                <tr>
                    ...
                    <x-table-th align="center" extra="lg:px-3 lg:py-2">
                        Stok Sistem
                    </x-table-th>
                    ...
                    <x-table-th :force="true" align="center">
                        Keterangan
                    </x-table-th>
            ...
            <tbody id="opname-table-body"
                ...
                <tr id="loading-row">
                    <td colspan="6"
                        class="px-3 py-6 md:px-6 md:py-10 text-center text-gray-500">
                        Memuat data stok...
                    </td>
                </tr>
            </tbody>
        ...
        <div class="mt-4 flex flex-col gap-3 border-t border-gray-200 pt-4 lg:flex-row lg:items-center lg:justify-between lg:gap-2">
            <p id="opname-pagination-info" class="text-sm text-gray-600">
                Memuat pagination...
            </p>
            ...
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                <button
                    id="opname-prev-page"
                    type="button"
                    onclick="goToPrevOpnamePage()"
                    class="px-4 py-2 rounded-lg border border-gray-300 text-gray-700 bg-white hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed">
                    Sebelumnya
                </button>
        ...
        <div class="bg-white rounded-2xl shadow-xl p-6 max-w-5xl w-full mx-4 max-h-[85vh] flex flex-col">
            <div class="flex items-center justify-between mb-4">
                ...
                <button
                    ...
                    class="text-slate-500 hover:text-slate-700 font-bold text-xl leading-none">
                    &times;
                </button>
            </div>
            ...
            <div class="mt-4 text-right">
                <button
                    onclick="closeHistoryModal()"
                    class="bg-slate-100 hover:bg-slate-200 text-slate-700 px-5 py-2 rounded-lg font-semibold">
                    Tutup
                </button>
            </div>
        </div>
    ...
    <div id="confirm-modal"
        ...
        <div class="w-full max-w-sm rounded-xl bg-white p-6 shadow-2xl mx-4">
            <div class="mb-4 flex items-center justify-between gap-4">
                ...
                <button
                    onclick="resolveOpnameConfirm(false)"
                    class="rounded-md bg-slate-100 px-2 py-1 text-slate-400 transition-colors hover:text-slate-600">
                    x
                </button>
            </div>

            <p id="confirm-body"
               class="mb-6 text-sm leading-relaxed text-slate-600"></p>
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <button
                    onclick="resolveOpnameConfirm(true)"
