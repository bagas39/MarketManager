...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Swalayan Segar'); ?></title>
    ...
    <div class="flex min-h-screen overflow-x-hidden">
        ...
        <nav id="sidebar" class="fixed inset-y-0 left-0 z-40 flex h-full w-64 -translate-x-full flex-col bg-gray-900 text-white transition-transform duration-300 lg:translate-x-0">
            <div class="flex items-start justify-between border-b border-gray-700 px-6 py-5 lg:justify-start">
                <div>
                    ...
                    <div class="mt-1 text-sm font-normal text-gray-200">
                        Halo, <?php echo e(Auth::check() ? Auth::user()->name : 'Guest'); ?> <br>
                        <span class="text-xs text-gray-400">(<?php echo e(Auth::check() ? Auth::user()->role : '-'); ?>)</span>
                    </div>
                </div>
            ...
            <ul class="flex-1 py-4 space-y-2">
                <?php if(in_array(Auth::user()?->role, ['Kasir', 'Supervisor'])): ?>
                <li>
                    <a href="<?php echo e(url('/')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('/') ? 'bg-green-600 text-white font-semibold' : 'text-gray-300 hover:bg-gray-700'); ?>">
                ...
                <?php if(in_array(Auth::user()?->role, ['Supervisor'])): ?>
                <li>
                    <a href="<?php echo e(url('/transaksi_penjualan')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('transaksi_penjualan') ? 'bg-green-600 text-white font-semibold' : 'text-gray-300 hover:bg-gray-700'); ?>">
                ...
                <?php if(in_array(Auth::user()?->role, ['Kasir', 'Gudang', 'Supervisor'])): ?>
                <li>
                    <a href="<?php echo e(url('/manajemen_stok')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('manajemen_stok') ? 'bg-green-600 text-white font-semibold' : 'text-gray-300 hover:bg-gray-700'); ?>">
                ...
                <?php if(in_array(Auth::user()?->role, ['Gudang', 'Supervisor'])): ?>
                <li>
                    <a href="<?php echo e(url('/transaksi_pembelian')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('transaksi_pembelian') ? 'bg-green-600 text-white font-semibold shadow-md' : 'text-gray-300 hover:bg-gray-700'); ?>">
                ...
                <?php if(in_array(Auth::user()?->role, ['Owner'])): ?>
                <li>
                    <a href="<?php echo e(url('/laporan_keuangan')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('laporan_keuangan') ? 'bg-green-600 text-white font-semibold' : 'text-gray-300 hover:bg-gray-700'); ?>">
                ...
                <?php if(in_array(Auth::user()?->role, ['Owner', 'Supervisor'])): ?>
                <li>
                    <a href="<?php echo e(url('/manajemen_pengguna')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('manajemen_pengguna') ? 'bg-green-600 text-white font-semibold' : 'text-gray-300 hover:bg-gray-700'); ?>">
                ...
                <?php if(in_array(Auth::user()?->role, ['Gudang', 'Supervisor'])): ?>
                <li>
                    <a href="<?php echo e(url('/stok_opname')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('stok_opname') ? 'bg-green-600 text-white font-semibold' : 'text-gray-300 hover:bg-gray-700'); ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                ...
                <?php if(in_array(Auth::user()?->role, ['Gudang', 'Supervisor'])): ?>
                <li>
                    <a href="<?php echo e(url('/prediksi_stok')); ?>" class="flex items-center space-x-3 px-6 py-3 rounded-lg mx-3 transition-colors <?php echo e(Request::is('prediksi_stok') ? 'bg-green-600 text-white font-semibold' : 'text-gray-300 hover:bg-gray-700'); ?>">
        ...
        <main class="flex-1 bg-gray-50 lg:ml-64">
            <?php if (! (View::hasSection('has_mobile_header'))): ?>
...
</html><?php /**PATH C:\xampp\htdocs\MarketManager\resources\views/layouts/app.blade.php ENDPATH**/ ?>