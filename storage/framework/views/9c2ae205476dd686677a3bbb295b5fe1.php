    ...
    <div class="bg-white p-8 rounded-xl shadow-lg w-full max-w-sm">
        ...
        <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
            ...
            <div>
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="admin@swalayan.com" required class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:outline-none transition">
            </div>
        ...
        <div class="mt-6 text-sm text-gray-600 text-center border-t pt-5">
            Pegawai baru? <a href="<?php echo e(route('register')); ?>" class="font-bold text-green-600 hover:text-green-800 transition">Daftar di sini</a>
        </div>
    </div>

</body>
</html><?php /**PATH C:\xampp\htdocs\MarketManager\resources\views/login.blade.php ENDPATH**/ ?>